...
2. Object-Oriented Design flaws:
   ...
   - violate Open / Closed principle. New rules require changing existing code in the `GildedRose#updateQuality`. It increases risk every time when rules added or changed.
